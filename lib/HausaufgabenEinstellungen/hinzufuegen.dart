...
class _HausaufgabeHinzufuegenState extends State<HausaufgabeHinzufuegen> {
  ...
  FaecherList faecherList = FaecherList();
  bool auswahl = false;
  Fach selectedFach = Fach('', SplayTreeMap());
...
String getSubtitlesFach(Fach fach){
  if(fach.name != ''){
  String subtitles = fach.name;
  return subtitles;
  }
  else{
    return '';
          ...
          Expanded(
            child: CupertinoPicker(
              ...
              scrollController: FixedExtentScrollController(
                initialItem: selectedFach,
              ),
              onSelectedItemChanged: (int selectedItem) =>
                  selectedFach = selectedItem,
              children: List<Widget>.generate(
                faecherList.faecher.length, (int i) => Center(child: Text(faecherList.faecher[i].name))
                  ),
            ),
          ),
          CupertinoButton(
              ...
              onPressed: () {
                setState(() {
                  this.selectedFach = faecherList.faecher[selectedFach];
                });
    ...
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        ...
        trailing: CupertinoButton(
          ...
          onPressed: () =>
              Navigator.of(context).pop(Hausaufgabe(selectedFach, _selectedName, _datum)),
        ),
      ),
      child: SafeArea(
            ...
            Row(
              ...
              children:[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(getSubtitlesFach(selectedFach)),
                    const Spacer(),
